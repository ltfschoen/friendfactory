module Posting::VideosHelper
  ...
  def link_to_youtube_video_image(posting, size = 'big')
    ...
    video_play_image_tag = image_tag('video-play.png', :class => 'play', :size => '100x100')
    link_to(video_image_tag << video_play_image_tag, posting.url, :'data-vid' => posting.vid, :class => 'play')
  end
